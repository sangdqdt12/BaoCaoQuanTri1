...
@Component({
  selector: 'app-bao-cao-trend-kinh-doanh1',
  templateUrl: './bao-cao-trend-kinh-doanh1.component.html',
  styleUrls: ['./bao-cao-trend-kinh-doanh1.component.scss']
})
export class BaoCaoTrendKinhDoanh1Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT01 - Báo cáo trend kinh doanh"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_TREND_BE04A(
