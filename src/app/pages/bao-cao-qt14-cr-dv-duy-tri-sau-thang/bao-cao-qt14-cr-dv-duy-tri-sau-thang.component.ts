...
@Component({
  selector: 'app-bao-cao-qt14-cr-dv-duy-tri-sau-thang',
  templateUrl: './bao-cao-qt14-cr-dv-duy-tri-sau-thang.component.html',
  styleUrls: ['./bao-cao-qt14-cr-dv-duy-tri-sau-thang.component.scss']
})
export class BaoCaoQt14CrDvDuyTriSauThangComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT14 - Báo cáo Cr duy trì sáu tháng"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_CR_03(
