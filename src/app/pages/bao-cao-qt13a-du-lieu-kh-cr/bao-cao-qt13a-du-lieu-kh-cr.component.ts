...
@Component({
  selector: 'app-bao-cao-qt13a-du-lieu-kh-cr',
  templateUrl: './bao-cao-qt13a-du-lieu-kh-cr.component.html',
  styleUrls: ['./bao-cao-qt13a-du-lieu-kh-cr.component.scss']
})
export class BaoCaoQt13aDuLieuKhCrComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT13a - Báo cáo dữ liệu khách hàng Cr"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_CR_02(
      this.khoiVal, this.capVal,this.draVal, sTuNgay,sDenNgay, "","", this.donviVal, this.userGetData
    );
