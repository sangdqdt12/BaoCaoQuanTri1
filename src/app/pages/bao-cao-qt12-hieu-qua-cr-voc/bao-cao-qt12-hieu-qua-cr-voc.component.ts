...
@Component({
  selector: 'app-bao-cao-qt12-hieu-qua-cr-voc',
  templateUrl: './bao-cao-qt12-hieu-qua-cr-voc.component.html',
  styleUrls: ['./bao-cao-qt12-hieu-qua-cr-voc.component.scss']
})
export class BaoCaoQt12HieuQuaCrVocComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.arrTrangThaiLoad = [false, false, false, false]
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT12 - Báo cáo hiệu quả cr voc"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_CR_01(
      this.khoiVal, this.capVal, this.thang1.toString(), this.nam1.toString(), this.draVal, "", "", this.donviVal, this.userGetData
    );
