...
@Component({
  selector: 'app-bao-cao-qt15-cr-dv-duy-tri-muoi-nam',
  templateUrl: './bao-cao-qt15-cr-dv-duy-tri-muoi-nam.component.html',
  styleUrls: ['./bao-cao-qt15-cr-dv-duy-tri-muoi-nam.component.scss']
})
export class BaoCaoQt15CrDvDuyTriMuoiNamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT15 - Báo cáo Cr dịch vụ duy trì 10 năm"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_CR_04(
