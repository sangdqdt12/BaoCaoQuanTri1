...
@Component({
  selector: 'app-bao-cao-qt16-cr-ban-hang-duy-tri-muoi-nam',
  templateUrl: './bao-cao-qt16-cr-ban-hang-duy-tri-muoi-nam.component.html',
  styleUrls: ['./bao-cao-qt16-cr-ban-hang-duy-tri-muoi-nam.component.scss']
})
export class BaoCaoQt16CrBanHangDuyTriMuoiNamComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reportService.GhiNhanLogSuDungMenu(
      "CP_LogSuDungMenu", this.userGetData, "QT16 - Báo cáo Cr bán hàng duy trì 10 năm"
    ).subscribe(t => {});
  ...
  fillData() {
    ...
    this.reportData1 = this.reportService.CP_WKPI_CR_05(
      this.khoiVal, this.capVal,this.nam1.toString(), "","", this.donviVal, this.userGetData
    );
