...
@Component({
  selector: 'app-dv01-bd02',
  templateUrl: './dv01-bd02.component.html',
  styleUrls: ['./dv01-bd02.component.scss']
})
export class Dv01Bd02Component extends ChartBaseComponent {
  public ReportID: string = "daskboard-dich-vu-chart2";
